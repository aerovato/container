...
bun build --compile --target=bun-linux-arm64 --outfile dist/container-linux-arm64 src/main.ts
bun build --compile --target=bun-linux-x64 --outfile dist/container-linux-x64 src/main.ts
