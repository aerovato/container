...
export const HARNESS_PACKS = {
  claude: {
    id: "claude",
    name: "Claude Code",
    shouldEnable: rt => rt.commandExists("claude"),
    dockerfileLines: [
  ...
  opencode: {
    id: "opencode",
    name: "OpenCode",
    shouldEnable: rt => rt.commandExists("opencode"),
  ...
  codex: {
    id: "codex",
    name: "OpenAI Codex",
    shouldEnable: rt => rt.commandExists("codex"),
  ...
  gemini: {
    id: "gemini",
    name: "Gemini CLI",
    shouldEnable: rt => rt.commandExists("gemini"),
  ...
  copilot: {
    ...
    shouldEnable: rt => rt.commandExists("copilot"),
  ...
  grok: {
    id: "grok",
    name: "Grok Build",
    shouldEnable: rt => rt.commandExists("grok"),
    dockerfileLines: [
  ...
  cursor: {
    id: "cursor",
    name: "Cursor CLI",
    shouldEnable: rt => rt.commandExists("cursor-agent"),
  ...
  nitro: {
    id: "nitro",
    name: "Aerovato Nitro",
    shouldEnable: rt => rt.commandExists("nitro"),
  ...
  antigravity: {
    ...
    shouldEnable: rt => rt.commandExists("agy"),
    dockerfileLines: [
