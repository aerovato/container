...
const TOS = `
\x1b[33mSecurity Advisory\x1b[0m

The purpose of 'container' is to protect commands like 'rm' or 'apt' from
unintentionally affecting your main system.

container does not protect against LLM-related security issues such as prompt
injections.
...
you agree that you are aware of these risks and will not hold the author liable
for any outcomes arising from usage of the software.
`.trim();
